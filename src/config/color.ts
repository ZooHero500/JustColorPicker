export const colorUnit = ['name', 'hex', 'rgb', 'hsl', 'hwb', 'cmyk', 'lab', 'lch']
...
export const shadcnUiColors: Record<string, shadcnUiColor[]> = {
  slate: [
    {
      scale: 50,
      hex: '#f8fafc',
